                ...
                <div class="col-md-8 profileContent"> <!-- Profile Content -->
                    <div class="col-md-12 profileContentPage">
                        ...
                        <div class="col-md-12"> <!-- Form Profile -->
                            ...
                            {!! Form::model($dayoffer,['method'=>'post','action'=>['BookController@storedayoffer',$dayoffer->id],'files'=>true]) !!}
                            ...
                            <div class="form-group"> <!-- Form Div -->
                                ...
                                <div>
                                    <input class="form-control" placeholder="" required="" name="code" type="text" value={{$dayoffer->code}} disabled>
                            ...
                            <div class="form-group"> <!-- Form Div -->
                                ...
                                <div>
                                    <input class="form-control" placeholder="" required="" name="product_name" type="text" value={{$dayoffer->name}} disabled>
                                </div>
                            </div> <!-- End Form Div -->
